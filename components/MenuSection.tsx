        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 lg:gap-24">
          {PRODUCTS.slice(0, 2).map((product, idx) => {
            return (
              ...
              >
                <div className="bg-froota-wood dark:bg-white/5 rounded-[32px] lg:rounded-[48px] p-8 lg:p-12 transition-all duration-700 group-hover:shadow-[0_40px_80px_rgba(0,0,0,0.05)] group-hover:-translate-y-2">
                  <div className="mb-6">
                  ...
                  <div className="flex flex-col sm:flex-row items-start justify-between gap-6">
                    <div className="space-y-2 lg:space-y-4">
                      <h3 className="text-3xl md:text-5xl lg:text-6xl font-impact text-froota-dark dark:text-white uppercase leading-none tracking-tight">
                        {product.name}
                      </h3>
                      <p className="text-base lg:text-xl text-froota-dark/40 dark:text-white/30 font-medium leading-relaxed max-w-lg">
                        {product.description}
                      </p>
                    </div>
